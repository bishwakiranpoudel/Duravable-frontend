...
export default function TypingIndicator() {
  return (
    <div className="flex items-start gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3">
      <div className="flex h-8 w-8 sm:h-9 sm:w-9 shrink-0 items-center justify-center rounded-xl gradient-health text-accent-foreground">
      ...
      <div>
        ...
        <div className="mt-1 rounded-2xl rounded-tl-sm bg-card border border-chat-ai-border px-4 sm:px-5 py-3 sm:py-3.5 shadow-card">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <span
              className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-accent animate-pulse-dot"
